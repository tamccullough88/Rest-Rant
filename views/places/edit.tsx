...
function edit_form(data: { place: { id: any; name: string | number | readonly string[] | undefined; pic: string | number | readonly string[] | undefined; city: string | number | readonly string[] | undefined; state: string | number | readonly string[] | undefined; founded: string | number | readonly string[] | undefined; cuisines: string | number | readonly string[] | undefined } }) {
